...
/// An implementation of [Alikit4Platform] that uses method channels.
class MethodChannelAlikit4 extends Alikit4Platform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('alikit4');

 ...
 * Alikit4Plugin
 */
public class Alikit4Plugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "alikit4");
